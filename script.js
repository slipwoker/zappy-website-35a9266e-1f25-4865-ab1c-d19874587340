...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '+972543882588';
      ...
      if (window.zappyContactFormLoaded) {
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: '35a9266e-1f25-4865-ab1c-d19874587340',
              name: fullName,
              email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מבריק עם גל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
